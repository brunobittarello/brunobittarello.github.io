...
{
    public class BrunoFreeLookCam : PivotBasedCameraRig
    {
        ...
        private void HandleRotationMovement()
        {
            ...
            // Read the user input
            var x = CrossPlatformInputManager.GetAxis("RightAxisHorizontal");
            var y = CrossPlatformInputManager.GetAxis("RightAxisVertical");
        ...
        void asdjkasdas()
        {
            var target = CheckpointManager.GetCheckpointPosition();
            ...
            m_LookAngle = look.eulerAngles.y;
            if (transform.position.y > target.y)
                m_TiltAngle = look.eulerAngles.x;
            else
                m_TiltAngle = look.eulerAngles.z;
        }
    }
}
